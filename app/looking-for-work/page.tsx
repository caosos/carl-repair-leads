...
export default function LookingForWorkPage() {
  return (
    <>
      <PageHero eyebrow="Same-day work board" title="Ready to work today?" description="Tell us what you can do and where you can go. We’re building a dependable list of local people for repair, labor, cleanup, and extra-hand jobs." />
