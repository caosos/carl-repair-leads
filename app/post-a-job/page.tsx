...
import { Field, LeadSourceField, MockForm, PhotoUpload, SelectField, TextAreaField } from "@/components/mock-form";
      ...
      <section className="form-section">
        <div className="container form-layout">
          <MockForm buttonLabel="Send my repair request" successText="Your mock repair request has been received. In the live version, CARL will follow up by phone or text.">
            ...
            <fieldset className="choice-field"><legend>What kind of help do you need?</legend><div className="choice-grid">
              {["Licensed Contractor", "Handyman / Small Repair", "Labor Help Today", "Drywall Repair"].map((type) => <label key={type} className={type === "Drywall Repair" ? "featured-choice" : ""}><input type="radio" name="service" value={type} required /><span>{type}</span></label>)}
            </div></fieldset>
